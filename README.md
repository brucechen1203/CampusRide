...
This project is built with Node.js and Express.js for the backend, and it uses SQLite as its lightweight database. To ensure user data security, all passwords are encrypted using bcrypt.

### Installation

1.  **Clone the repository**
    ```bash
    git clone https://github.com/brucechen1203/CampusRide.git
    ```
2.  **Navigate to the project directory**
    ```bash
    cd CampusRide_Prototype_App
    ```
